...
- In fact, here each module connects to it's own USB 5V power supply. (Again), these ESP32 did not give enough power to power the MAX3232 chip from there own pins, so here I make there there is plenty of green power for both adapters. They could share one 5V power supply. 
